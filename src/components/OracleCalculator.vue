<template>
  <v-card :style="{ backgroundColor: mainPanelBgColor, color: mainPanelTextColor }">
    <v-card-text>
      ...
      <!-- VCN Summary -->
      <v-card v-if="vcnInfo" class="mt-4" variant="outlined" :style="{ backgroundColor: nestedPanelBgColor, color: nestedPanelTextColor }">
      ...
      <!-- Subnets -->
      <v-expansion-panels v-if="subnets.length > 0" class="mt-4" multiple :style="{ backgroundColor: mainPanelBgColor }">
        <v-expansion-panel
          ...
          <v-expansion-panel-text :style="{ backgroundColor: mainPanelBgColor, color: mainPanelTextColor }">
            <v-row>
              ...
              <v-col cols="12" md="6">
                <v-list density="compact" :style="{ backgroundColor: mainPanelBgColor, color: mainPanelTextColor }">
                  <v-list-item>
                    <v-list-item-title class="font-weight-bold">OCI Reserved IPs</v-list-item-title>
                  </v-list-item>
...
const themeStyles = computed(() => getThemeStyles('oracle', isDarkMode.value))
