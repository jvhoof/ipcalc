...
export interface ThemeColors {
  ...
  infoBoxText: string // Requirements info box text color
  infoBoxBorder: string     // Requirements info box border
  alertBoxBackground: string // Alert box background
  alertBoxText: string      // Alert box text color
  alertBoxBorder: string    // Alert box border/side line color
...
export const cloudThemes: Record<string, CloudTheme> = {
  ...
  gcp: {
    ...
    light: {
      ...
      alertBoxBackground: '#D2E3FC',
      alertBoxText: '#1967D2',
      alertBoxBorder: '#4285F4',
      // App-level colors
    ...
    dark: {
      ...
      infoBoxText: '#F5F5F5',
      infoBoxBorder: '#F5F5F5',
      alertBoxBackground: '#1A3A5F',
      alertBoxText: '#AECBFA',
      alertBoxBorder: '#669DF6',
      // App-level colors
  ...
  oracle: {
    ...
    light: {
      ...
      subnetChip: '#C74634',
      subnetChipText: '#FFFFFF',
      usableIpsText: '#000000',
      dialogHeader: '#C74634',
      dialogHeaderText: '#FFFFFF',
      infoBoxBackground: '#FDE8E5',
      infoBoxText: '#8B2F1F',
      infoBoxBorder: '#C74634',
      alertBoxBackground: '#FADBD7',
      alertBoxText: '#8B2F1F',
      alertBoxBorder: '#C74634',
      // App-level colors
    ...
    dark: {
      ...
      infoBoxText: '#F5F5F5',
      infoBoxBorder: '#F5F5F5',
      alertBoxBackground: '#3A1F1A',
      alertBoxText: '#FFAA99',
      alertBoxBorder: '#E86B56',
      // App-level colors
  ...
  alicloud: {
    ...
    light: {
      ...
      alertBoxBackground: '#FFE8CC',
      alertBoxText: '#994000',
      alertBoxBorder: '#FF6A00',
      // App-level colors
    ...
    dark: {
      ...
      infoBoxText: '#F5F5F5',
      infoBoxBorder: '#F5F5F5',
      alertBoxBackground: '#3A2A1A',
      alertBoxText: '#FFB366',
      alertBoxBorder: '#FF8C33',
      // App-level colors
  ...
  aws: {
    ...
    light: {
      ...
      alertBoxBackground: '#FFEAD9',
      alertBoxText: '#995c00',
      alertBoxBorder: '#FF9900',
      // App-level colors
  ...
  'on-premises': {
    ...
    light: {
      ...
      alertBoxBackground: '#CCEDEB',
      alertBoxText: '#004F4C',
      alertBoxBorder: '#00A99D',
      // App-level colors
...
export function getThemeStyles(provider: string, isDarkMode: boolean = false) {
  ...
  return {
    ...
    alertBox: {
      backgroundColor: colors.alertBoxBackground,
      color: colors.alertBoxText,
      borderColor: colors.alertBoxBorder,
    },
  }
}
